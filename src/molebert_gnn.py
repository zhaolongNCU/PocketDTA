...
class GINConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr):
        #add self loops in the edge space加入自环边
...
class DiscreteGNN(torch.nn.Module):
    ...
    Output:
        node representations
    """
    def __init__(self, num_layer, emb_dim, JK = "last", 
    ...
    def forward(self, *argv):
        ...
        return node_representation     #N*300
...
class GNN_graphpred(torch.nn.Module):
    ...
    def forward(self, *argv):
        ...
        return self.graph_pred_linear(self.pool(node_representation, batch)), node_representation #B*任务数和[总节点个数，300]
